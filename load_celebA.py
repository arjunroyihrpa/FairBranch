...
def load_celeba(protected='Age',batch_size=8192,return_ft=False):
    f=open('/yourpath/CelebA/list_attr_celeba.txt').read()
    Ft=f.split('\n')[1].split()
    ...
    if return_ft:
        ...
        return dt,yt, gt, d_v, yv, gv, dataloader_test, y_test, g_test,batch_size